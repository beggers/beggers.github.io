---
title: Caused-based alerts
layout: BlogPost.astro
slug: cause-based-alerts
pubDate: 2023-01-23
tags: [alerting]
---
...
talks to a database, does some work, and sends back a response.

This is a toy example but it generalizes pretty easily.
...
### "But Ben, the database slowing down is a leading indicator for degraded user
performance! I want to know when something is going to go wrong!"
...
accomplishes is degrading your quality of life.e
